...
@section('content')
    <div class="menu">
        <div class="container-custom">
            <h2 class="text-center mt-3 mb-3">Pizzas</h2>
            <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                @foreach($pizzas as $menuItem)
                    <div class="col">
                            ...
                            <div class="card-body d-flex flex-column text-center">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-success mt-auto addToCart"
                                            ...
                                            data-route="{{ route('cart.index') }}">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <h2 class="text-center mt-3 mb-3">Coffee</h2>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                @foreach($coffees as $menuItem)
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('images/' . $menuItem->image) }}" class="card-img-top" alt="{{ $menuItem->name }}">
                            <div class="card-body d-flex flex-column text-center">
            ...
            <h2 class="text-center mt-3 mb-3">Promotions</h2>
            <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
                @foreach($promotions as $menuItem)
                    <div class="col">
                        <div class="card h-100">
                            <img src="{{ asset('images/' . $menuItem->image) }}" class="card-img-top" alt="{{ $menuItem->name }}">
                            <div class="card-body d-flex flex-column text-center">
